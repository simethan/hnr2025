...
export default function Home() {
  ...
  const getCookedDescription = (score: number) => {
    if (score < 2) return "You're practically raw! Time to fire up that coding grill!"
    if (score < 4) return "You're a rare find in the CS world. Keep coding!"
    if (score < 6) return "You're cooking with gas now! Medium rare and ready for more challenges."
